...
//        mockMvc.perform(get("/course/gif/SOS"))
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(asJsonString("https://giphy.com/gifs/tiktok-animals-tough-tiktok-WoRz0xf3fUBWTWXUJ0"))
//                .andExpect(MockMvcResultMatchers.status().is3xxRedirection());
//    }
//        
////    (MockMvcRequestBuilders.get("/course/gif/SOS"))
////                .contentType(MediaType.APPLICATION_JSON)
////                .content(asJsonString("https://giphy.com/gifs/tiktok-animals-tough-tiktok-WoRz0xf3fUBWTWXUJ0"))
////                .andExpect(MockMvcResultMatchers.status().is3xxRedirection());
//
